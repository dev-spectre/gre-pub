...
export function SignUpForm() {
  ...
  return (
    <div className="w-full max-w-[34rem] relative isolate">
      ...
      <p className="text-center text-sm-0  mt-3 absolute w-full">
        Already have an account? <Link className="text-[#1B438F] font-semibold" href={"/signin"}>Sign In</Link>{" "}
      </p>
    </div>
  );
}
